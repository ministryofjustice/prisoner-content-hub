...
module.exports.featuredImageUrlFrom = R.view(R.lensPath(['field_featured_image', 0, 'url']));
module.exports.featuredImageAltFrom = R.view(R.lensPath(['field_featured_image', 0, 'alt']));

module.exports.featuredVideoUrlFrom = R.view(R.lensPath(['field_featured_video', 0, 'url']));

module.exports.featuredAudioUrlFrom = R.view(R.lensPath(['field_featured_audio', 0, 'url']));
