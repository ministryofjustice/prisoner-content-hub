function engineGame(options) {
  ...
  var cfg = {
      ...
      draggable: true,
      position: 'start',
      pieceTheme: '/public/images/chesspieces/{piece}.png',
  ...
  return {
      ...
      setHash: function (value) {
          uciCmd('setoption name Hash value ' + value);
      },
      setThreads: function (value) {
          uciCmd('setoption name Threads value ' + value);
      },
      setMinimumThinkingTime: function (value) {
          uciCmd('setoption name Minimum Thinking Time value ' + value);
      },
