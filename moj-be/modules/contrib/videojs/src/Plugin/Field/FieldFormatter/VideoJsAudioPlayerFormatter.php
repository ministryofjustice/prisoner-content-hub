...
/**
 * @file
 * Contains \Drupal\videojs\Plugin\Field\FieldFormatter\VideJsAudioPlayerFormatter.
 */
...
/**
 * Plugin implementation of the 'videojs_audio_player' formatter.
 *
 * @FieldFormatter(
 *   id = "videojs_audio_player",
 *   label = @Translation("Video.js Audio Player"),
 *   field_types = {
 *     "file",
 *     "video",
 *   }
...
class VideoJsAudioPlayerFormatter extends VideoJsAudioPlayerFormatterBase implements ContainerFactoryPluginInterface {
  ...
  public function settingsSummary() {
    $summary = array();
    $summary[] = t('HTML5 Audio (@widthx@height@controls@autoplay@loop@muted).', [
